...
import com.ssafy.authsvr.payload.response.UserDetailResponse;
...
public class AuthController {
    ...
    public ApiResponse getUser() {
        ...
        UserDetailResponse detailResponse = UserDetailResponse.detailResponse(userService.findDetailsUser(principal.getUsername()));
